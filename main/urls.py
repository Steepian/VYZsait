...
urlpatterns = [
    ...
    path('faculty-review/<int:review_id>/edit/', views.edit_faculty_review, name='edit_faculty_review'),
    path('faculty-review/<int:review_id>/delete/', views.delete_faculty_review, name='delete_faculty_review'),
